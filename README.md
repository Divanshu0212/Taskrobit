...
(The Deployment Links are given below in the Live Deployment section, The backend takes a bit about 1min to start due to the Free tier deployment on render)
## Features
